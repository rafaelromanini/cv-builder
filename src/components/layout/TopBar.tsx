...
import { Download, Edit3, Eye, FileDown, MoreHorizontal, Settings } from 'lucide-react';
...
export function TopBar({
  ...
  const Logo = () => (
    <div className="flex items-center gap-2.5">
      ...
      <div>
        <div
          className="font-semibold text-stone-900 dark:text-stone-100 text-sm leading-tight"
  ...
  return (
    <>
      <header
        className="bg-white dark:bg-stone-900 border-b border-stone-200 dark:border-stone-800 sticky top-0 z-30 no-print transition-colors"
      ...
      >
        ...
        <div className="md:hidden px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-xl bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-300 hover:bg-stone-200 dark:hover:bg-stone-700 transition"
        ...
        {/* ── Desktop header ────────────────────────────── */}
        <div className="hidden md:flex max-w-400 mx-auto px-6 py-3 items-center justify-between flex-wrap gap-2">
          <Logo />
